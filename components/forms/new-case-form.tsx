        ...
        <CardContent className="p-0">
          ...
          <Label htmlFor="file-upload" className="cursor-pointer block">
            <div className="flex flex-col items-center justify-center space-y-3">
              ...
              <p className="text-lg font-semibold text-gray-900">Przeciągnij i upuść pliki tutaj</p>
              <p className="text-sm text-gray-600">lub</p>
              <Button type="button" variant="outline">
                Wybierz pliki
              </Button>
              <p className="text-xs text-gray-500">PDF, JPG, PNG (max 10MB na plik)</p>
            </div>
          </Label>
      ...
      {isSubmitting && (
        <div className="space-y-2">
          ...
          <p className="text-center text-sm text-gray-600">
            {uploadProgress < 100 ? `Wysyłanie dokumentów... ${uploadProgress}%` : "Przetwarzanie sprawy..."}
          </p>
        </div>
      )}
