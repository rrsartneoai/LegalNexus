...
let browserSupabase: ReturnType<typeof createSupabaseClient<Database>> | undefined
...
export function createClient() {
  ...
  if (typeof window !== "undefined") {
    if (!browserSupabase) {
      browserSupabase = createSupabaseClient<Database>(supabaseUrl, supabaseAnonKey)
    }
